...
import { assets, Job, JobCategories, JobLocations } from '../assets/assets';
...
const JobListing = () => {
    ...
    if (!context) {
      ...
      useEffect(()=>{
        ...
        const matchesTitle = (job: Job) => searchFilter.title === "" || job.title.toLowerCase().includes(searchFilter.title.toLowerCase());
