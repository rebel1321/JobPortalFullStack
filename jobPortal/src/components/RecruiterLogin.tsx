...
const RecruiterLogin = () => {
  ...
  const [isTextDataSubmitted, setIsTextDataSubmitted] = useState<boolean>(false);
  ...
  return (
    <div className="absolute top-0 left-0 right-0 bottom-0 z-10 backdrop-blur-sm flex justify-center items-center">
        ...
        {state === "Sign Up" && isTextDataSubmitted ? (
          <>
            <div className="flex items-center gap-4 my-10">
              <label htmlFor="image">
                <img className="w-16 rounded-full" src={image? URL.createObjectURL(image): assets.upload_area} alt="Upload" />
