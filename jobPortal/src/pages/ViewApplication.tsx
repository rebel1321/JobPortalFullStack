    ...
    <div className="container mx-auto p-4">
        <div>
          <table className="w-full max-w-4xl bg-white border border-gray-200 max-sm:text-sm">
            <thead>
              <tr className="border border-white shadow">
            ...
            <tbody>
              {applicants.filter(item=>item.jobId && item.userId).map((applicant,index)=>(
                <tr key={index} className="text-gray-700">
                  ...
                  <td className="py-2 px-4 border-b border-gray-200 text-center flex items-center"><img className="w-10 h-10 rounded-full mr-3 max-sm:hidden" src={applicant.userId.image} alt="" />
                  ...
                  <td className="py-2 px-4 border-b border-gray-200 ">
                    <a className="bg-blue-50 text-blue-400 px-3 py-1 rounded inline-flex gap-2 items-center" href={applicant.userId.resume} target="blank">Resume <img src={assets.resume_download_icon} alt="" /></a>
                  </td>
