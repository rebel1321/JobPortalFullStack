            ...
            <tbody>
              {viewApplicationsPageData.map((applicant,index)=>(
                <tr key={index} className="text-gray-700">
                  ...
                  <td className="py-2 px-4 border-b border-gray-200 text-center flex"><img className="w-10 h-10 rounded-full mr-3 max-sm:hidden" src={applicant.imgSrc} alt="" />
                  ...
                  <td className="py-2 px-4 border-b border-gray-200 ">
                    <a className="bg-blue-50 text-blue-400 px-3 py-1 rounded inline-flex gap-2 items-center" href="" target="blank">Resume <img src={assets.resume_download_icon} alt="" /></a>
                  </td>
